...
xcparse screenshots --model `xcodebuild test -target UITests -scheme Markology -destination "name=iPhone 8 Plus" -destination "name=iPhone 11 Pro Max" -destination "name=iPad Pro (12.9-inch) (4th generation)" | grep xcresult`
